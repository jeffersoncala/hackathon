      ...
      <div class="caixa-dados">
        ...
        <div class="caixa-input">
          ...
          <div v-if="requestType == 'Produto'">
            <v-text-field class="input1" label="Nome Produto" v-model="inputTexto"></v-text-field>
            <v-select label="Categoria" item-title="name" v-model="selectCategoria" :items="[{
              id: 'restaurant',
          ...
          <div v-else>
            <v-text-field class="input1" label="Email" v-model="inputTexto" />
          </div>
...
export default {
  ...
  data() {
    return {
      inputTexto: "",
      selectCategoria: "",
      requestTypes: ['Produto', 'Email'],
      requestType: 'Produto'
    };
  },
  methods: {
    functionRouter() {
      if (this.requestType == 'Produto') {
        router.push({
          name: 'analytics/:input/:selectInput', params: {
            input: this.inputTexto,
            selectInput: this.selectCategoria
          }
        });
      } else {
        router.push({
          name: 'analytics/:input', params: {
            input: this.inputTexto
          }
        });
      }
